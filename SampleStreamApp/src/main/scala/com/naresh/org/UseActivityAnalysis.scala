...
//spark-submit --packages org.apache.spark:spark-streaming_2.11:2.2.1 --jars $(echo ~/.ivy2/jars/*.jar | tr ' ' ',') --class com.naresh.org.UseActivityAnalysis target/SampleStreamApp-1.0-SNAPSHOT.jar useractivity jeep
